...
Eigen::MatrixXd ypd2xyz_jacobian(const Eigen::Vector3d & ypd)
{
  ...
  double dx_dyaw = distance * cos_pitch * -sin_yaw;
  double dy_dyaw = distance * cos_pitch * cos_yaw;
  double dz_dyaw = 0.0;

  double dx_dpitch = distance * -sin_pitch * cos_yaw;
  double dy_dpitch = distance * -sin_pitch * sin_yaw;
  double dz_dpitch = distance * cos_pitch;

  double dx_ddistance = cos_pitch * cos_yaw;
  double dy_ddistance = cos_pitch * sin_yaw;
  double dz_ddistance = sin_pitch;
